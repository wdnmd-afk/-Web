(() => {
  ...
  const fullscreen = node('playerFullscreenBtn');
  ...
  // 原生全屏由画面内图标条统一提供，隐藏 <video> 自带的全屏按钮避免两套入口
  ...
  fullscreen.addEventListener('click', toggleNativeFullscreen);
  window.JukuNativeFullscreen = toggleNativeFullscreen;
